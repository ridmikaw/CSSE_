...
const SignIn = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100"> {/* Flexbox to center content */}
      <div className="signin-container max-w-md mx-auto p-6 border border-gray-300 rounded-lg shadow-lg">
